...
def y1_to_lengths_angles(
    ...
    """
    Decode Y1 into physical lengths and angles in degrees.
...
def lattice_latent_to_lengths_angles(
    latent: torch.Tensor,
    lattice_repr: str,
    log_len_min: float = -5.0,
    log_len_max: float = 5.0,
    ...
    y1 = lattice_latent_to_y1(latent, lattice_repr=lattice_repr)
    return y1_to_lengths_angles(
        y1,
        log_len_min=log_len_min,
        log_len_max=log_len_max,
        cos_clip=cos_clip,
    )
