    ...
    *,
    ...
    if bool(model_args.get("discrete_types", False)):
        raise ValueError(
            ...
            "discrete_types=True. Re-sample from a continuous-EDM checkpoint or retrain "
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--sampler", type=str, default=None, choices=["edm", "vfm", "catflow"])
...
def main() -> None:
    ...
    print(
        ...
        f"num_steps={sample_num_steps} atom_count={atom_count_strategy} sampler={sampler_name}"
    )
