...
class Crystal:
    ...
    def get_structure(self):
        ...
        if atom_types.size == 0:
            ...
            self.invalid_reason = "empty_structure"
        elif min(self.lengths) < 0:
            self.constructed = False
        ...
        elif (1 > atom_types).any() or (atom_types > 104).any():
            self.constructed = False
            self.invalid_reason = f"{atom_types=} are not with range"
        else:
            try:
